import { Button, Grid, InputBase, Link, Paper, TextField } from '@material-ui/core';
...
function AddPlace(props) {
    ...
    return(<>
        ...
        <div class="table-wrapper">
            <table class="place_table">
                <tbody>
                    ...
                    <tr> 
                        <td class="place_name">
                            <a href="#none" onclick="makeOverlay(155);">구미AA카페</a>
                        </td> 
                    ...
                    <tr> 
                        <td class="place_name">
                            <a href="#none" onclick="makeOverlay(276);">구미BB마트</a>
                        </td> 
                    ...
                    <tr> 
                        <td class="place_name">
                            <a href="#none" onclick="makeOverlay(439);">구미CC고기</a>
                        </td> 
        ...
        <div class="pageinate">    
        <div class="cont">        
        <a href="#none" class="arr prev off">이전페이지</a>        
        <a href="#none" class="active">1</a>        
        <a href="javascript:renderSearchResult(2)">2</a>        
        <a href="javascript:renderSearchResult(3)">3</a>        
        <a href="javascript:renderSearchResult(2)" class="arr next">다음페이지</a>    </div></div></div>
